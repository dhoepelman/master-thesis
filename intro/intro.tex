...
Of these refactorings, \rf{Inline Formula}, \rf{Group References} and \rf{Introduce Conditional Aggregate} where not implemented in any previous work known to us, and \rf{Extract Formula} and \rf{Introduce Aggregate} offer significant improvements over previous implementations.
