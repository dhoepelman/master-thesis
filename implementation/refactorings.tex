...
The refactoring can be used to solve the \rf{Multiple References} \cite{hermans2014bumblebee} smell in some cases, but only if the referenced cells are adjacent but referred to separately.
