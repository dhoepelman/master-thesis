...
\todo{Misschien uitleggen waarom dit niet met Bumblebee transformation rules kan inclusief plaatje? Omgekeerde sutatie. In =XXXX[a]XXXX match Bumblebee XXXX en captured [a], terwijl deze refactoring [a] matched en XXXX captured.}
