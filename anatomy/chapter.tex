...
Firstly there is the range operator \f{:} then the union operator (\f{,} in Excel, \f{\~} in OpenFormula) and lastly the intersection operator (\f{\char32} in Excel, \f{!} in OpenFormula).
